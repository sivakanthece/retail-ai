...
CATEGORY_PROMPT_TEMPLATES = {
    ...
    "Milk & Dairy Drinks": [
        "a tall rectangular milk carton or plastic jug of cow's milk in a supermarket fridge — NOT wine",
        "a white plastic bottle of semi-skimmed or whole milk with a coloured cap and dairy branding",
        "a tetra-pak or gable-top carton of fresh milk — clearly labelled milk, not alcohol",
        "a bottle or carton of plant-based milk — oat, soy, or almond — on a grocery shelf",
        "a dairy drink like cream, buttermilk, or chocolate milk in a fridge display — opaque white packaging",
        "fresh milk packaging with a cow or farm image on the label in a refrigerator section",
    ],
    "Cheese": [
    ...
    "Ice Cream & Frozen Desserts": [
        "a large round tub of Ben & Jerry's or Häagen-Dazs ice cream in a supermarket freezer",
        "a box of individually wrapped ice cream bars, Magnums, or frozen popsicles",
        "a rectangular ice cream container with a branded flavour name printed on the lid",
        "a carton of gelato, sorbet, or frozen yogurt in a freezer display unit",
        "a bag of frozen berries or frozen fruit for desserts in a freezer section",
    ],
    "Bread & Bakery": [
    ...
    "Chips & Crisps": [
        "a large shiny foil bag of Lay's, Pringles, or Walkers potato chips on a snack shelf",
        "a cylindrical Pringles tube with pop-off lid on a store shelf",
        "a packet of tortilla chips, corn chips, or nachos in a foil bag",
        "a brightly coloured metallic foil bag of flavoured crisps on a snack aisle",
        "a multi-pack of small individual crisp bags in a supermarket",
        "a big crinkle-cut or kettle chip bag with a bold brand logo",
    ],
    "Nuts & Seeds": [
    ...
    "Water & Juice": [
        "a clear or blue plastic bottle of still or sparkling water on a shelf",
        "a carton or glass bottle of orange juice or apple juice with fruit imagery",
        "a six-pack of water bottles with minimal clear label on a store shelf",
        "a glass bottle of craft lemonade or fruit-flavoured sparkling drink",
        "a Fentimans or San Pellegrino style glass bottle of natural soda",
        "a bottle of fruit juice, coconut water, or smoothie with a colourful label",
    ],
    "Soda & Energy Drinks": [
        "a red Coca-Cola bottle or can with white script logo on a supermarket shelf",
        "a green Sprite bottle with Sprite logo — a carbonated lemon-lime soda",
        "an orange Fanta bottle with Fanta logo — a carbonated fruit soft drink",
        "a large 1.5 litre or 2 litre plastic bottle of branded cola or fizzy soda",
        "a Pepsi, 7UP, or Dr Pepper can or plastic bottle on a drinks shelf",
        "a can of cola, lemonade, or carbonated soft drink in a supermarket fridge",
        "a tall slim can of energy drink like Red Bull or Monster with bold graphics",
        "a multi-pack of branded soda cans — Coca-Cola, Sprite, Fanta or similar",
    ],
    "Tea & Coffee": [
    ...
    "Wine & Spirits": [
        "a tall dark glass wine bottle with a cork, paper label, and foil capsule on a dedicated wine shelf — NOT milk",
        "a bottle of whiskey, gin, vodka, or rum with a spirit brand label in a liquor aisle",
        "a wine bottle with a decorative paper label and metal foil at the neck — clearly an alcohol product",
        "spirits or liquor bottles — Jack Daniel's, Absolut, Hendricks — on a dedicated liquor shelf in an alcohol section",
        "a boxed wine or magnum wine bottle clearly labelled with an alcohol brand in the drinks aisle",
    ],
    "Canned Goods": [
    ...
    "Baby Products": [
        "a tall cylindrical tin of powdered infant formula with a baby or toddler image on the label — NOT a drink bottle",
        "a large bulky pack of nappies or baby diapers in plastic packaging on a baby aisle shelf",
        "a small glass jar of pureed baby food labelled Stage 1 or Stage 2 infant food",
        "baby-specific products: nappy cream, baby wipes, or baby lotion on a dedicated baby aisle",
        "infant formula packaging — a tin or carton specifically marketed for feeding babies — NOT adult beverages",
    ],
    "Pet Food": [
