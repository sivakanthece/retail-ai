...
CATEGORY_PROMPT_TEMPLATES = {
    ...
    "Milk & Dairy Drinks": [
        "a tall rectangular milk carton or jug of cow's milk in a supermarket fridge",
        "a white plastic bottle of semi-skimmed or whole milk with a coloured cap",
        "a tetra-pak or gable-top carton of fresh milk or flavoured milk drink",
        "a bottle or carton of plant-based milk — oat, soy, or almond — on a shelf",
        "a glass or plastic bottle with dairy milk branding and white liquid visible",
        "a dairy drink like cream, buttermilk, or chocolate milk in a fridge display",
    ],
    "Cheese": [
    ...
    "Wine & Spirits": [
        "a tall dark glass bottle of red or white wine with a cork and paper label on a wine shelf",
        "a bottle of whiskey, gin, vodka, or rum with a spirit brand label in a liquor store",
        "a wine bottle with a decorative paper label and metal foil capsule at the top",
        "spirits or liquor bottles — Jack Daniel's, Absolut, Hendricks — on a dedicated liquor shelf",
        "a boxed wine or magnum wine bottle in a supermarket alcohol aisle",
    ],
    "Canned Goods": [
    ...
    "Baby Products": [
        "a tall cylindrical tin of powdered infant formula with baby imagery on the label",
        "a large bulky pack of nappies or baby diapers in plastic packaging",
        "a small glass jar or squeezable pouch of pureed baby food",
        "baby food jars, nappy packs, and infant care products on a dedicated baby shelf",
        "a box of baby wipes or a tub of nappy rash cream on a store shelf",
    ],
    "Pet Food": [
