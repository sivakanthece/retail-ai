...
export const detectionAPI = {
  ...
  pipeline: (eventId, detections, shelfId = 'SHELF-A1', usePlanogram = true) =>
    api.post('/detection/pipeline', { event_id: eventId, detections, shelf_id: shelfId, use_planogram: usePlanogram }),
